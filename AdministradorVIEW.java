...
public class AdministradorVIEW extends javax.swing.JFrame {
    int cont = 5;
    Aluno aluno[] = new Aluno[cont];
    Acao prin = new Acao();
//    prin.cadastrarNovos();
    
    DefaultTableModel dadosAluno;
    /**
    ...
    private void initComponents() {
        ...
        tblListaAln.setModel(new javax.swing.table.DefaultTableModel(
            ...
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.String.class, java.lang.Long.class, java.lang.String.class, java.lang.Long.class, java.lang.Long.class
            };
        ...
        if (tblListaAln.getColumnModel().getColumnCount() > 0) {
            tblListaAln.getColumnModel().getColumn(0).setResizable(false);
            tblListaAln.getColumnModel().getColumn(1).setResizable(false);
            tblListaAln.getColumnModel().getColumn(2).setResizable(false);
            tblListaAln.getColumnModel().getColumn(3).setResizable(false);
            tblListaAln.getColumnModel().getColumn(4).setResizable(false);
            tblListaAln.getColumnModel().getColumn(5).setResizable(false);
        }
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        objAluno.setNome(txtNomeAln.getText());
        objAluno.setTelefone(Long.parseLong(txtTelefoneAln.getText()));
        objAluno.setCurso(txtCursoAln.getText());
        objAluno.setDataNasc(Long.parseLong(txtDataNascAln.getText()));
        objAluno.setCpf(Long.parseLong(txtCPFAln.getText()));
        
//        dadosAluno.insertRow(dadosAluno.getRowCount(),
//                new Object[]{
//                    null, txtNomeAln.getText(),txtTelefoneAln.getText(), txtCursoAln.getText(),txtDataNascAln.getText(), txtCPFAln.getText()
//                });
        
        
        DefaultTableModel dadosAluno = (DefaultTableModel) tblListaAln.getModel();
        Object[] dados = {null, txtNomeAln.getText(), txtTelefoneAln.getText(), txtCursoAln.getText(), txtDataNascAln.getText(), txtCPFAln.getText()};
        dadosAluno.addRow(dados);
        int cont =5;
        Aluno aluno[] = new Aluno[cont];
    ...
    private void btnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverActionPerformed
        ...
        DefaultTableModel dadosAluno = (DefaultTableModel) tblListaAln.getModel();
        dadosAluno.removeRow(tblListaAln.getSelectedRow());
        } else {
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        if(tblListaAln.getSelectedRow() != -1){
        tblListaAln.setValueAt(txtNomeAln.getText(), tblListaAln.getSelectedRow(),1);
        tblListaAln.setValueAt(txtTelefoneAln.getText(), tblListaAln.getSelectedRow(),2);
        tblListaAln.setValueAt(txtCursoAln.getText(), tblListaAln.getSelectedRow(),3);
        tblListaAln.setValueAt(txtDataNascAln.getText(), tblListaAln.getSelectedRow(),4);
        tblListaAln.setValueAt(txtCPFAln.getText(), tblListaAln.getSelectedRow(),5);
